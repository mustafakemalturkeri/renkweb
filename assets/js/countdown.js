...
class CountdownTimer {
    ...
    showExpiredMessage(element) {
        ...
        element.innerHTML = `
            ...
            <h3>🎉 Yayında! 🎉</h3>
            <a href="https://open.spotify.com/album/4e5eF8VfP6902yxblf4M0K" target="_blank" rel="noopener" class="spotify-btn" style="display:inline-block;padding:8px 16px;background:#1DB954;color:#fff;border-radius:24px;text-decoration:none;font-weight:bold;margin-top:10px;">
