...
class CountdownTimer {
    ...
    showExpiredMessage(element) {
        element.innerHTML = `
            ...
            <h3>🎉 Yayında! 🎉</h3>
            <a href="https://open.spotify.com/track/2RkKEB6VVN8XWwbqDdivK9?si=5113c007bf9b4d7e" target="_blank" rel="noopener" class="spotify-btn" style="display:inline-block;padding:8px 16px;background:#1DB954;color:#fff;border-radius:24px;text-decoration:none;font-weight:bold;margin-top:10px;">
